...
class BattleshipGame:
    ...
    def place_ship(self, board, ship, s, ori, x, y):
        """accepts board, ship size, and position, places ship, it should already be verified by user_place_ships function orient ships"""
        if ori == "V":
            for i in range(ship):
                board[x + i][y] = s
        elif ori == "H":
    ...
    def main(self):
        # types of ships
        ships = {"Carrier": 5, "Battleship": 4, "Submarine": 3, "Destroyer": 3, "Patrol Boat": 2}
